...
export default function Bap() {
    ...
    const [bap_meet, setbap_meet] = useState({
        meeting_name:"",
        meeting_agenda:"",
        cometee_type:"",
        meeting_date:""
    ...
    const handleInputs = (e) => {
      ...
      setbap_meet({ ...bap_meet, [name]: value });
    };
    const PostData = async (e) => {
      e.preventDefault();
      const { meeting_name,meeting_agenda,cometee_type, meeting_date} = bap_meet;

  
      const res = await fetch("/bap", {
        method: "POST",
        headers: {
    ...
    <form className="row g-4 ps-5 pe-5 pt-3 d-flex flex-column fs-6">
        ...
        <div className="row mb-1">
            ...
            <div className="col-sm-6">
                ...
                value={bap_meet.meeting_date}
                onChange={handleInputs}
                />
            </div>
        </div>

        <div className="row mb-2" name="meeting_agenda"
        value={bap_meet.meeting_agenda}
        onChange={handleInputs}
        >
...
<div className="container shadow bg-body rounded text-start pb-3 ps-0 pe-0 mt-5" style={{"width":"90%"}}>
    ...
    <form className="row g-4 ps-5 pe-5 pt-3 d-flex flex-column fs-6">
        ...
        <div className="row mb-2">
            <label for="exampleFormControlTextarea1 " class="form-label col-sm-3 d-flex justify-content-end" 
