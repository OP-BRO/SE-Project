...
export default function Bap() {
  return (
    ...
    <h1 className="mb-3">--- BAP Meetings  ---</h1> <hr /> 
        <br /> 
    <form className="row g-4 ps-5 pe-5 pt-3 d-flex flex-column fs-6">
        ...
        <button type="button" class="btn btn-secondary">Add Meeting Details</button>
    </div>
...
<div className="container ps-5 mb-5 pt-2 shadow bg-body rounded text-start pb-3 mt-5" style={{"width":"90%"}}>
    <h1 className="mb-3">--- Archive Meeting   ---</h1> <hr /> 
        <br /> 
    <form className="row g-4 ps-5 pe-5 pt-3 d-flex flex-column fs-6">
        <div className="row mb-1">
            <label htmlforName="inputStudentName" className="col-sm-3 col-form-label d-flex justify-content-end">Meeting Name:</label>
        ...
        <div className="d-flex justify-content-center my-3">
        <button type="button" class="btn btn-secondary">Add to Archive</button>
    </div>
